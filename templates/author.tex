...
%
\title{Insights in Machine Learning for Cyber-Security Assessment}
%
\titlerunning{Cyber-Security Assessment}  % abbreviated title (for running head)
%                                     also used for the TOC unless
%                                     \toctitle is used
%
\author{César Benavente-Peces\inst{1} \and David Bartolini\inst{2}}
%Jeffrey Dean \and David Grove \and Craig Chambers \and Kim~B.~Bruce \and
%Elsa Bertino}
%
\authorrunning{César Benavente- Peces et al.} % abbreviated author list (for running head)
%
%%%% list of authors for the TOC (use if author list has to be modified)
\tocauthor{Ivar Ekeland, Roger Temam, Jeffrey Dean, David Grove,
Craig Chambers, Kim B. Bruce, and Elisa Bertino}
%
\institute{Universidad Politécnica de Madrid, ETSIS Telecomunicación, Campus Sur, Calle de Nikola Tesla sn, 28031 Madrid, España,\\
\email{cesar.benavente@upm.es},\\ WWW home page:
